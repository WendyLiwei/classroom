...
(function(global) {
    ...
    function mixin(e, t, n, r) {
        return t && eachProp(t, function(t, i) {
            if (n || !hasProp(e, i))
                r && typeof t == "object" && t && !isArray(t) && !isFunction(t) && !(t instanceof RegExp) ? (e[i] || (e[i] = {}),
    ...
    function newContext(e) {
        ...
        function g(e, t, n) {
            ...
            e && e.charAt(0) === "." && (t ? (g = v.slice(0, v.length - 1),
            e = e.split("/"),
            l = e.length - 1,
            o.nodeIdCompat && jsSuffixRegExp.test(e[l]) && (e[l] = e[l].replace(jsSuffixRegExp, "")),
            e = g.concat(e),
            m(e),
            e = e.join("/")) : e.indexOf("./") === 0 && (e = e.substring(2)));
            if (n && y && (v || b)) {
                s = e.split("/");
        ...
        function E(e, t, n, i) {
            ...
            f && (f = g(f, l, i),
            o = getOwn(c, f)),
            e && (f ? o && o.normalize ? m = o.normalize(e, function(e) {
                return g(e, l, i)
            }) : m = g(e, l, i) : (m = g(e, l, i),
            a = w(m),
            f = a[0],
        ...
        function x(e, t, n) {
            var r = e.id
              , i = getOwn(u, r);
            hasProp(c, r) && (!i || i.defineEmitComplete) ? t === "defined" && n(c[r]) : (i = S(e),
            i.error && t === "error" ? n(i.error) : i.on(t, n))
        }
        function T(e, t) {
        ...
        function N() {
            globalDefQueue.length && (apsp.apply(l, [l.length, 0].concat(globalDefQueue)),
            globalDefQueue = [])
        }
        function C(e) {
            delete u[e],
        ...
        function k(e, t, n) {
            ...
            each(e.depMaps, function(r, i) {
                var s = r.id
                  , o = getOwn(u, s);
                o && !e.depMatched[i] && !n[s] && (getOwn(t, s) ? (e.defineDep(i, c[s]),
                e.check()) : k(o, t, n))
            }),
            n[r] = !0)
        }
        function L() {
            ...
            if (u && f.length)
                return e = makeError("timeout", "Load timeout for modules: " + f, null, f),
        ...
        n.prototype = {
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(o)) {
                            if (this.events.error && this.map.isDefine || req.onError !== defaultOnError)
                                ...
                                s = r.execCb(n, o, i, s);
                            this.map.isDefine && s === undefined && (t = this.module,
                            ...
                            s = o;
                        this.exports = s,
                        this.map.isDefine && !this.ignore && (c[n] = s,
            ...
            callPlugin: function() {
                ...
                x(n, "defined", bind(this, function(n) {
                    var i, s, a, f = getOwn(p, this.map.id), l = this.map.name, c = this.map.parentMap ? this.map.parentMap.name : null, h = r.makeRequire(e.parentMap, {
                        enableBuildCallback: !0
                    });
                    if (this.map.unnormalized) {
                        ...
                        a = getOwn(u, s.id),
                        a && (this.depMaps.push(s),
                        this.events.error && a.on("error", bind(this, function(e) {
                            this.emit("error", e)
                        })),
                        a.enable());
                        return
        ...
        r = {
            ...
            makeRequire: function(t, n) {
                function s(o, a, f) {
                    ...
                    typeof o == "string" ? isFunction(a) ? T(makeError("requireargs", "Invalid require call"), f) : t && hasProp(i, o) ? i[o](u[t.id]) : req.get ? req.get(r, o, t, s) : (h = E(o, t, !1, !0),
                    l = h.id,
                    hasProp(c, l) ? c[l] : T(makeError("notloaded", 'Module name "' + l + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (_(),
                    r.nextTick(function() {
                        _(),
                        p = S(E(null, t)),
                        p.skipMap = n.skipMap,
                ...
                mixin(s, {
                    ...
                    toUrl: function(e) {
                        ...
                        return i !== -1 && (!o || i > 1) && (n = e.substring(i, e.length),
                        e = e.substring(0, i)),
                ...
                t || (s.undef = function(e) {
                    ...
                    r && (r.events.defined && (f[e] = r.events),
                    C(e))
                }
                ),
                s
...
function(e, t) {
    ...
    function showHide(e, t) {
        ...
        for (; o < u; o++) {
            ...
            r.style.display === "" && isHidden(r) && (s[o] = data_priv.access(r, "olddisplay", defaultDisplay(r.nodeName)))) : (i = isHidden(r),
            (n !== "none" || !i) && data_priv.set(r, "olddisplay", i ? n : jQuery.css(r, "display")))
        }
        for (o = 0; o < u; o++) {
            r = e[o];
            if (!r.style)
    ...
    jQuery.fn.load = function(e, t, n) {
        ...
        return u >= 0 && (r = jQuery.trim(e.slice(u)),
        e = e.slice(0, u)),
...
define("utils/dropdown", ["jQuery"], function(e) {
    var t = function(t) {
      ...
      , r = function() {
        e(document).on("click", ".toggle-dropdown", t),
        e(document).on("click", ".dropdown-menu", function(e) {
            e.stopPropagation()
        }),
...
define("core/font-settings", ["jQuery", "utils/storage"], function(e, t) {
    var n, r = {
        ...
        var t = e(".book")
          , r = e(this).data("theme");
        n.theme !== 0 && t.removeClass("color-theme-" + n.theme),
        n.theme = r,
        n.theme !== 0 && t.addClass("color-theme-" + n.theme),
        n.save()
    }, f = function() {
        var t = e(".book");
        e(".font-settings .font-family-list li").removeClass("active"),
        e(".font-settings .font-family-list li:nth-child(" + (n.family + 1) + ")").addClass("active"),
        t[0].className = t[0].className.replace(/\bfont-\S+/g, ""),
        t.addClass("font-size-" + n.size),
        t.addClass("font-family-" + n.family),
        n.theme !== 0 && (t[0].className = t[0].className.replace(/\bcolor-theme-\S+/g, ""),
        t.addClass("color-theme-" + n.theme))
    }, l = function(l) {
        var c, h, p, d;
        d = e(".book"),
        c = e(".book-header .toggle-font-settings"),
        p = e("#font-settings-wrapper .dropdown-menu"),
        h = e(".book-body"),
        n = t.get("fontState", {
            size: l.size || 2,
        ...
        ,
        f(),
        e(document).on("click", "#enlarge-font-size", s),
        e(document).on("click", "#reduce-font-size", o),
        e(document).on("click", "#font-settings-wrapper .font-family-list .button", u),
        e(document).on("click", "#font-settings-wrapper .color-theme-list .button", a)
    };
    return {
        init: l,
        update: f
...
define("core/state", ["jQuery"], function() {
    ...
    return e.update = function(t) {
        var n = $(t.find(".book"));
        e.$book = n,
        e.githubId = n.data("github"),
        e.level = n.data("level"),
        e.basePath = n.data("basepath"),
        e.revision = n.data("revision")
    }
    ,
    e.update($),
    e
...
function(e, t, n) {
    ...
    function T(e, t, n, r) {
        if (B.stopCallback(t, t.target || t.srcElement, n, r))
            return;
        e(t, n) === !1 && (S(t),
        x(t))
    }
    function N(e, t, n) {
        var r = w(e, t, n), i, s = {}, o = 0, u = !1;
        for (i = 0; i < r.length; ++i)
            r[i].seq && (o = Math.max(o, r[i].level));
        for (i = 0; i < r.length; ++i) {
            if (r[i].seq) {
                if (r[i].level != o)
                    continue;
                u = !0,
                s[r[i].seq] = 1,
                T(r[i].callback, n, r[i].combo, r[i].seq);
                continue
            }
    ...
    function O(e, t, n) {
        return n || (n = A()[e] ? "keydown" : "keypress"),
        n == "keypress" && t.length && (n = "keydown"),
        n
    }
    function M(e, t, n, r) {
        function i(t) {
    ...
    e.Mousetrap = B,
    typeof define == "function" && define.amd && define("Mousetrap", B)
}(window, document),
function(e) {
    function S(e) {
...
function(e, t) {
    ...
    s.encodeQuery = function(e, t) {
        var n = s.encode(e + "");
        return t === undefined && (t = s.escapeQuerySpace),
        t ? n.replace(/%20/g, "+") : n
    }
    ,
    s.decodeQuery = function(e, t) {
        e += "",
        t === undefined && (t = s.escapeQuerySpace);
        try {
    ...
    s.parseHost = function(e, t) {
        ...
        t.port === "/" && (t.port = null)) : e.indexOf(":") !== e.lastIndexOf(":") ? (t.hostname = e.substring(0, n) || null,
    ...
    s.withinString = function(e, t, n) {
        ...
        for (; ; ) {
            ...
            c = f + h.length;
            var p = t(h, f, c, e);
            e = e.slice(0, f) + p + e.slice(c),
            r.lastIndex = f + p.length
        }
    ...
    o.protocol = function(e, t) {
        if (e !== undefined && e) {
            e = e.replace(/:(\/\/)?$/, "");
            if (!e.match(s.protocol_expression))
    ...
    o.normalizePath = function(e) {
        ...
        if (!this._parts.path || this._parts.path === "/")
            return this;
        var t, n = this._parts.path, r = "", i, o;
        n.charAt(0) !== "/" && (t = !0,
        n = "/" + n),
        n = n.replace(/(\/(\.\/)+)|(\/\.$)/g, "/").replace(/\/{2,}/g, "/"),
        t && (r = n.substring(1).match(/^(\.\.\/)+/) || "",
        r && (r = r[0]));
        for (; ; ) {
            i = n.indexOf("/..");
            if (i === -1)
            ...
            o = n.substring(0, i).lastIndexOf("/"),
            o === -1 && (o = i),
            n = n.substring(0, o) + n.substring(i + 3)
        }
        return t && this.is("relative") && (n = r + n.substring(1)),
        n = s.recodePath(n),
        this._parts.path = n,
        this.build(!e),
        this
    ...
    o.absoluteTo = function(e) {
        ...
        return t._parts.path ? t._parts.path.substring(-2) === ".." && (t._parts.path += "/") : (t._parts.path = e._parts.path,
        t._parts.query || (t._parts.query = e._parts.query)),
        t.path().charAt(0) !== "/" && (r = e.directory(),
...
define("utils/url", ["URIjs/URI"], function(e) {
    function t(t, n) {
        var r = new e(n);
        return r.is("relative") && (r = r.absoluteTo(t)),
        r.toString()
    }
    function n(e) {
        return t(e, "..")
...
function() {
    ...
    function X(e) {
        var t = -1
          ...
          , i = e[n / 2 | 0]
          , s = e[n - 1];
        if (r && typeof r == "object" && i && typeof i == "object" && s && typeof s == "object")
            return !1;
        var o = J();
    ...
    function Y(t) {
        ...
        function _t(e, t, n, r, i) {
            ...
            if (t) {
                ...
                s = f ? G(e) : sn({}, e);
            return f && (ht.call(e, "index") && (s.index = e.index),
            ht.call(e, "input") && (s.input = e.input)),
            t ? (r.push(e),
            i.push(s),
            (f ? Jn : dn)(e, function(e, o) {
                s[o] = _t(e, t, n, r, i)
            }),
            l && (K(r),
            K(i)),
        ...
        function Pt(e, t, n) {
            ...
            if (typeof t != "undefined" && "prototype"in e) {
                ...
                if (typeof r == "undefined") {
                    Ot.funcNames && (r = !e.name),
                    r = r || !Ot.funcDecomp;
                    if (!r) {
                        var i = lt.call(e);
                        Ot.funcNames || (r = !p.test(i)),
                        r || (r = g.test(i),
                        $t(e, r))
                    }
                }
        ...
        function Ft(e, t, n, r, i, s) {
            ...
            if (!c) {
                ...
                if (h || p)
                    return Ft(h ? e.__wrapped__ : e, p ? t.__wrapped__ : t, n, r, i, s);
                if (f != k)
                    return !1;
                var d = e.constructor
                  , v = t.constructor;
                if (d != v && !(Nn(d) && d instanceof d && Nn(v) && v instanceof v) && "constructor"in e && "constructor"in t)
                    return !1
            }
            var m = !i;
            i || (i = $()),
            ...
            if (c) {
                ...
                if (o || r)
                    while (y--) {
                        ...
                        if (r) {
                            while (b--)
                                if (o = Ft(e[b], w, n, r, i, s))
                                    break
                        } else if (!(o = Ft(e[y], w, n, r, i, s)))
                            break
                    }
            } else
                hn(t, function(t, u, a) {
                    if (ht.call(a, u))
                        return y++,
                        o = ht.call(e, u) && Ft(e[u], t, n, r, i, s)
                }),
        ...
        function zt(e, t, n, r, i, s) {
            ...
            if (h && h !== !0)
                ...
                !o && h[1] & 1 && (t |= 8),
                a && !(h[1] & 4) && (h[5] = s),
                l && pt.apply(h[2] || (h[2] = []), n),
                c && mt.apply(h[3] || (h[3] = []), r),
                h[1] |= t,
                zt.apply(null, h);
        ...
        function Jt(e) {
            var t, n;
            return !!e && st.call(e) == k && (t = e.constructor,
            !Nn(t) || t instanceof t) ? (hn(e, function(e, t) {
                n = t
            }),
        ...
        function on(e, t, n, r) {
            return typeof t != "boolean" && t != null && (r = n,
            n = t,
            t = !1),
            _t(e, t, typeof n == "function" && Pt(n, r, 1))
        }
        function un(e, t, n) {
        ...
        function ln(e, t, n) {
            var r;
            return t = Lt.createCallback(t, n, 3),
            dn(e, function(e, n, i) {
                if (t(e, n, i))
                    return r = n,
                    !1
        ...
        function Hn(e) {
            ...
            if (n > 3 && typeof t[n - 2] == "function")
                var r = Pt(t[--n - 1], t[n--], 2);
            else
                n > 2 && typeof t[n - 1] == "function" && (r = t[--n]);
        ...
        function In(e, t, n, r) {
            ...
            return t && (t = Lt.createCallback(t, r, 4),
            (i ? Jn : dn)(e, function(e, r, i) {
                return t(n, e, r, i)
            })),
            n
        }
        ...
        function Un(e, t, n) {
            var r = -1
              ...
              , s = e ? e.length : 0
              , o = !1;
            return n = (n < 0 ? xt(0, s + n) : n) || 0,
            Gt(e) ? o = i(e, t, n) > -1 : typeof s == "number" ? o = (_n(e) ? e.indexOf(t, n) : i(e, t, n)) > -1 : dn(e, function(e) {
                if (++r >= n)
                    return !(o = e === t)
            }),
            o
        ...
        function er(e, t, n) {
            ...
            if (t == null && Gt(e)) {
                ...
                t = t == null && _n(e) ? z : Lt.createCallback(t, n, 3),
                Jn(e, function(e, n, s) {
                    var o = t(e, n, s);
                    o > r && (r = o,
                    i = e)
        ...
        function ir(e, t, n, r) {
            var i = arguments.length < 3;
            return t = Lt.createCallback(t, r, 4),
            Kn(e, function(e, r, s) {
                n = i ? (i = !1,
                e) : t(n, e, r, s)
            }),
        ...
        function or(t, n, r) {
            ...
            if (n == null || r)
                return t ? t[qt(0, t.length - 1)] : e;
            var i = ur(t);
            return i.length = Tt(xt(0, n), i.length),
            i
        }
        function ur(e) {
            var t = -1
        ...
        function Lr(e, t, n, r) {
            var i = 0
              , s = e ? e.length : i;
            n = n ? Lt.createCallback(n, r, 1) : Zr,
            t = n(t);
            while (i < s) {
                var o = i + s >>> 1;
                n(e[o]) < t ? i = o + 1 : s = o
        ...
        function Or(e, t, n, r) {
            ...
            n = typeof t != "function" && r && r[t] === e ? null : t,
            t = !1),
            n != null && (n = Lt.createCallback(n, r, 3)),
            Rt(e, t, n)
        }
        function Mr(e) {
        ...
        function _r() {
            ...
            while (++e < t) {
                var n = arguments[e];
                if (Gt(n) || Qt(n))
                    var r = r ? Rt(Bt(r, n).concat(Bt(n, r))) : n
            }
            return r || []
        }
        function Dr() {
        ...
        function qr(e, t) {
            return t = typeof t == "number" ? t : +t || e.length,
            zt(e, 4, null, null, null, t)
        }
        function Rr(t, n, r) {
            ...
            if (r === !0) {
                ...
                Cn(r) && (d = r.leading,
                h = "maxWait"in r && (xt(n, r.maxWait) || 0),
            ...
            return function() {
                ...
                if (h === !1)
                    ...
                    g ? (s && (s = at(s)),
                    c = u,
                    o = t.apply(a, i)) : s || (s = dt(m, r))
                }
                return g && f ? f = at(f) : !f && n !== h && (f = dt(v, n)),
                e && (g = !0,
                o = t.apply(a, i)),
                g && !f && !s && (i = a = null),
                o
        ...
        function Jr(e, t, n) {
            ...
            if (!Nn(e))
                throw new tt;
            return n === !1 ? r = !1 : Cn(n) && (r = "leading"in n ? n.leading : r,
        ...
        function oi(e, t, n) {
            var r = e == null
              , i = t == null;
            n == null && (typeof e == "boolean" && i ? (n = e,
            e = 1) : !i && typeof t == "boolean" && (n = t,
            i = !0)),
            r && i && (t = 1),
            e = +e || 0,
            i ? (t = e,
        ...
        function ai(t, n, r) {
            ...
            t = et(t || ""),
            r = fn({}, r, i);
            var s = fn({}, r.imports, i.imports), o = Zt(s), u = qn(s), h, p = 0, v = r.interpolate || m, g = "__p += '", b = U((r.escape || m).source + "|" + v.source + "|" + (v === d ? c : m).source + "|" + (r.evaluate || m).source + "|$", "g");
            t.replace(b, function(e, n, r, i, s, o) {
                return r || (r = i),
                g += t.slice(p, o).replace(y, V),
                n && (g += "' +\n__e(" + n + ") +\n'"),
                s && (h = !0,
                g += "';\n" + s + ";\n__p += '"),
                r && (g += "' +\n((__t = (" + r + ")) == null ? '' : __t) +\n'"),
            ...
            S || (E = "obj",
            g = "with (" + E + ") {\n" + g + "\n}\n"),
            g = (h ? g.replace(a, "") : g).replace(f, "$1").replace(l, "$1;"),
        ...
        kt[L] = U,
        kt[A] = et,
        At.prototype = Lt.prototype;
        var Ot = Lt.support = {};
        Ot.funcDecomp = !Vt(t.WinRTError) && g.test(Y),
        Ot.funcNames = typeof B.name == "string",
        Lt.templateSettings = {
            escape: /<%-([\s\S]+?)%>/g,
            evaluate: /<%([\s\S]+?)%>/g,
            interpolate: d,
        ...
        : Yt
          ...
          , sn = function(e, t, n) {
            ...
            if (a > 3 && typeof o[a - 2] == "function")
                var f = Pt(o[--a - 1], o[a--], 2);
            else
                a > 2 && typeof o[a - 1] == "function" && (f = o[--a]);
            while (++u < a) {
                i = o[u];
                if (i && D[typeof i]) {
                    var l = -1
        ...
        Lt.VERSION = "2.4.1",
        Lt.prototype.chain = di,
        Lt.prototype.toString = vi,
        Lt.prototype.value = mi,
        Lt.prototype.valueOf = mi,
        Jn(["join", "pop", "shift"], function(e) {
            var t = nt[e];
    ...
    var e, t = [], n = [], r = 0, i = +(new Date) + "", s = 75, o = 40, u = " 	\f ﻿\n\r\u2028\u2029 ᠎             　", a = /\b__p \+= '';/g, f = /\b(__p \+=) '' \+/g, l = /(__e\(.*?\)|\b__t\)) \+\n'';/g, c = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, h = /\w*$/, p = /^\s*function[ \n\r\t]+\w/, d = /<%=([\s\S]+?)%>/g, v = RegExp("^[" + u + "]*0+(?=.$)"), m = /($^)/, g = /\bthis\b/, y = /['\n\r\t\u2028\u2029\\]/g, b = ["Array", "Boolean", "Date", "Function", "Math", "Number", "Object", "RegExp", "String", "_", "attachEvent", "clearTimeout", "isFinite", "isNaN", "parseInt", "setTimeout"], w = 0, E = "[object Arguments]", S = "[object Array]", x = "[object Boolean]", T = "[object Date]", N = "[object Function]", C = "[object Number]", k = "[object Object]", L = "[object RegExp]", A = "[object String]", O = {};
    O[N] = !1,
    O[E] = O[S] = O[x] = O[T] = O[C] = O[k] = O[L] = O[A] = !0;
    var M = {
        leading: !1,
        maxWait: 0,
        trailing: !1
    ...
    var Z = Y();
    typeof define == "function" && typeof define.amd == "object" && define.amd ? (H._ = Z,
...
define("core/loading", ["jQuery"], function(e) {
    var t = function(t) {
        return e(".book").addClass("is-loading"),
        t.always(function() {
...
function() {
    ...
    e.tokenizer = function(e) {
        if (!arguments.length || e == null || e == undefined)
            return [];
        if (Array.isArray(e))
    ...
    e.Vector.prototype.insert = function(t, n) {
        var r = this.list;
        if (!r)
            return this.list = new e.Vector.Node(t,n,r),
            this.length++;
        var i = r
          , s = r.next;
        while (s != undefined) {
            if (t < s.idx)
                return i.next = new e.Vector.Node(t,n,s),
                this.length++;
            i = s,
            s = s.next
        }
    ...
    e.Vector.prototype.dot = function(e) {
        var t = this.list
          ...
          , r = 0;
        while (t && n)
            t.idx < n.idx ? t = t.next : t.idx > n.idx ? n = n.next : (r += t.val * n.val,
            t = t.next,
            n = n.next);
        return r
    }
    ...
    e.SortedSet.prototype.locationFor = function(e, t, n) {
        ...
        if (s < e)
            return this.locationFor(e, i, n);
        if (s > e)
            return this.locationFor(e, t, i)
    }
    ,
    ...
    e.Index.prototype.add = function(t, n) {
        ...
        this._fields.forEach(function(n) {
            ...
            r[n.name] = s,
            e.SortedSet.prototype.add.apply(i, s)
        }, this),
        this.documentStore.set(s, i),
    ...
    e.Index.prototype.idf = function(e) {
        ...
        var n = this.tokenStore.count(e)
          , r = 1;
        return n > 0 && (r = 1 + Math.log(this.tokenStore.length / n)),
        this._idfCache[t] = r
    }
    ,
        ...
        n.forEach(function(t, n, o) {
            var u = 1 / o.length * this._fields.length * s
              ...
              , f = this.tokenStore.expand(t).reduce(function(n, i) {
                ...
                return s > -1 && r.insert(s, u * o * f),
                Object.keys(a.tokenStore.get(i)).forEach(function(e) {
                    l.add(e)
                }),
                n.union(l)
            }, new e.SortedSet);
    ...
    e.Store.load = function(t) {
        ...
        n.store = Object.keys(t.store).reduce(function(n, r) {
            return n[r] = e.SortedSet.load(t.store[r]),
            n
        }, {}),
        n
    }
    ...
    e.stemmer = function() {
        ...
        return function(n) {
            ...
            if (n.length < 3)
                return n;
            c = n.substr(0, 1),
            c == "y" && (n = c.toUpperCase() + n.substr(1)),
            h = /^(.+?)(ss|i)es$/,
            p = /^(.+?)([^s])s$/,
            h.test(n) ? n = n.replace(h, "$1$2") : p.test(n) && (n = n.replace(p, "$1$2")),
            h = /^(.+?)eed$/,
            p = /^(.+?)(ed|ing)$/;
            if (h.test(n)) {
                var g = h.exec(n);
                ...
                p.test(n) ? n += "e" : d.test(n) ? (h = /.$/,
                n = n.replace(h, "")) : m.test(n) && (n += "e"))
            }
            h = /^(.+?)y$/;
            if (h.test(n)) {
                var g = h.exec(n);
            ...
            if (h.test(n)) {
                ...
                h = new RegExp(a),
                p = new RegExp(u),
                d = new RegExp("^" + i + r + "[^aeiouwxy]$");
                if (h.test(s) || p.test(s) && !d.test(s))
                    n = s
            }
            return h = /ll$/,
            p = new RegExp(a),
            h.test(n) && p.test(n) && (h = /.$/,
            n = n.replace(h, "")),
            c == "y" && (n = c.toLowerCase() + n.substr(1)),
            n
        }
    }(),
    ...
    e.TokenStore.prototype.expand = function(e, t) {
        var n = this.getNode(e)
          , r = n.docs || {}
          , t = t || [];
        return Object.keys(r).length && t.push(e),
...
define("core/sidebar", ["jQuery", "lodash", "utils/storage", "utils/platform", "core/state"], function(e, t, n, r, i) {
    var s = function(e, t) {
        if (i != null && o() == e)
            return;
        t == null && (t = !0),
        i.$book.toggleClass("without-animation", !t),
        i.$book.toggleClass("with-summary", e),
        n.set("sidebar", o())
    }
      , o = function() {
...
define("core/search", ["jQuery", "lodash", "lunr", "utils/storage", "core/state", "core/sidebar"], function(e, t, n, r, i, s) {
    var o = null
      ...
      , l = function(t) {
        ...
        i.$book.toggleClass("with-search", t),
        c() ? (s.toggle(!0),
        n.focus()) : (n.blur(),
        n.val(""),
        s.filter(null))
      ...
      , h = function() {
        a(),
        e(document).on("click", ".book-header .toggle-search", function(e) {
            e.preventDefault(),
            l()
        }),
      ...
      , p = function() {
        var n = r.get("keyword", "");
        n.length > 0 && (c() || l(),
        s.filter(t.pluck(f(n), "path"))),
        e(".book-search input").val(n)
    };
    return {
        init: h,
        search: f,
    ...
    var r = null
      ...
      , a = function() {
        e(document).on("click", ".book-body .page-wrapper .page-inner .glossary-term", function(t) {
            t.preventDefault(),
            location.href = n.basePath + "/GLOSSARY.html#" + e(t.currentTarget).data("glossary-term")
        })
    }
      , f = function(t, n) {
        var r = new RegExp("\\b(" + u(n.name.toLowerCase()) + ")\\b","gi");
        t.find("p:contains('" + n.name + "')").each(function(t, i) {
            i = e(i);
            var s = e(i).html();
            s = s.replace(r, '<span class="glossary-term" data-glossary-term="' + n.id + '" title="' + n.description + '">$1</span>'),
            i.html(s)
        })
    }
      , l = function() {
...
define("core/navigation", ["jQuery", "utils/url", "core/events", "core/state", "core/progress", "core/loading", "core/search", "core/glossary"], function(e, t, n, r, i, s, o, u) {
    var a, f, l = typeof history.pushState != "undefined", c = function(n, i) {
        ...
        return s.show(e.get(u).done(function(t) {
            ...
            t = t.replace(/<(\/?)(html|head|body)([^>]*)>/ig, function(e, t, n, r) {
            ...
            a.toggleClass("with-summary", e(".book").hasClass("with-summary")),
            e(".book").replaceWith(a),
            e(".book").attr("class", l),
            e(".book-summary .summary").scrollTop(c),
            r.update(e("html")),
            o.recover(),
            p()
        }).fail(function(e) {
        ...
        var t, n;
        t = parseInt(e(".body-inner").css("width"), 10),
        n = parseInt(e(".page-wrapper").css("width"), 10),
        e(".navigation-next").css("margin-right", t - n + "px")
    }, p = function() {
        ...
        ,
        e(document).on("click", ".navigation-prev", d),
        e(document).on("click", ".navigation-next", d),
        e(document).on("click", ".summary [data-path] a", d),
        e(window).resize(h),
        p()
    };
    return {
...
define("gitbook", ["jQuery", "utils/storage", "utils/sharing", "utils/dropdown", "core/events", "core/font-settings", "core/state", "core/keyboard", "core/navigation", "core/progress", "core/sidebar", "core/search", "core/glossary"], function(e, t, n, r, i, s, o, u, a, f, l, c, h) {
    var p = function(e) {
        var f;
        f = o.$book,
        o.githubId && t.setBaseKey(o.githubId),
        l.init(),
        c.init(),
        h.init(),
        u.init(),
